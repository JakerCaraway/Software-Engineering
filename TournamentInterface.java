...
public class TournamentInterface extends javax.swing.JFrame {
   ...
   // TableModel tableModel;
    ...
    /**
     * used to put the name of the player that won the tournament at the top of the UI. Also sorts the table
     */
    public void updateWinnerLabel(){
        ((SETableModle)table_players.getModel()).sort();
        label_winnerOfMatch.setText("TOURNEAMENT WINNER: "+ ((SETableModle)table_players.getModel()).getPlayer(0).getName());
    }
    ...
    private void initComponents() {
        ...
        label_competing = new javax.swing.JLabel();
        label_winnerOfMatch = new javax.swing.JLabel();
        button_resetScores = new javax.swing.JButton();
        ...
        label_competing.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_competing.setText("Now competing:");

        label_winnerOfMatch.setText("Winner: ");

        button_resetScores.setText("Reset Scores");
        button_resetScores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_resetScoresActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(61, 61, 61)
                        .addComponent(label_competing)
                        .addGap(118, 118, 118)
                        .addComponent(label_winnerOfMatch)
                        .addGap(158, 158, 158)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(button_mainMenu, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(button_resetScores, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
                .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(button_resetScores)
                        .addGap(41, 41, 41)
    ...
    private void button_runTournamentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_runTournamentActionPerformed
        ...
        if (playersToCompte.size() < 2){
            ...
            tournamentUIWorker worker = new tournamentUIWorker(game_world,playersToCompte,this);
            worker.execute();
        }
    }//GEN-LAST:event_button_runTournamentActionPerformed
    
    /**
     * used to get the label which shows who won the last match
     * @return the label of who won the last match
     */
    public JLabel getLabel_winnerOfMatch(){
        return label_winnerOfMatch;
    }
    
    /**
     * used to get the label that shows the players that are competing
     * @return the label that shows which players are competing
     */
    public JLabel getLabel_competing() {
        return label_competing;
    }
    ...
    /**
     * Button to reset the scores of all players
     * @param evt the button being pressed
     */
    private void button_resetScoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_resetScoresActionPerformed
        // TODO add your handling code here:
        for (int i = 0; i < table_players.getModel().getRowCount(); i++){
            ((SETableModle) table_players.getModel()).getPlayer(i).setScore(0);
        }
    }//GEN-LAST:event_button_resetScoresActionPerformed
    ...
    private javax.swing.JButton button_resetScores;
    ...
    private javax.swing.JLabel label_competing;
    private javax.swing.JLabel label_tournamentRunning;
    private javax.swing.JLabel label_winnerOfMatch;
